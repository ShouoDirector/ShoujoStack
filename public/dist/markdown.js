...
function init(modules, domApi, options) {
  ...
  function createElm(vnode2, insertedVnodeQueue) {
    ...
    if (data !== void 0) {
      const init4 = (_a2 = data.hook) === null || _a2 === void 0 ? void 0 : _a2.init;
      if (isDef(init4)) {
        init4(vnode2);
        data = vnode2.data;
      }
...
var Display = class {
  ...
  updateVisibility(show2) {
    ...
    wrap.style.display = show2 ? null : "none";
  }
  onLoad() {
...
var Actions = class {
  ...
  showImageManager() {
    ...
    const imageManager = window.$components.first("image-manager");
    imageManager.show((image2) => {
      __privateMethod(this, _insertDrawing, insertDrawing_fn).call(this, image2, selectionRange);
    }, "drawio");
  }
...
${content}`);
  ...
  cycleCalloutTypeAtSelection() {
    ...
    if (format2 === formats[formats.length - 1]) {
      __privateMethod(this, _wrapLine, wrapLine_fn).call(this, `<p class="callout ${formats[formats.length - 1]}">`, "</p>");
    } else if (format2 === "") {
      ...
      const newContent = line.text.replace(matches[0], matches[0].replace(format2, newFormat));
...
setText_fn = function(text2, selectionRange = null) {
  ...
  __privateMethod(this, _dispatchChange, dispatchChange_fn).call(this, 0, this.editor.cm.state.doc.length, text2, newSelectFrom);
  this.focus();
};
...
findAndReplaceContent_fn = function(search, replace2) {
  const newText = __privateMethod(this, _getText, getText_fn).call(this).replace(search, replace2);
...
// resources/js/markdown/index.mjs
